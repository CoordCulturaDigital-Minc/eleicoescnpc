...
class MetaBoxFeatureURL {
    ...
    static function init() {
        ...
        self::$custom_meta_fields = array(
            array(
                'label'         => __( 'URL', 'historias' ),
                'description'   => __( 'Link for the Featured Image', 'historias' ),
    ...
    /**
     * To appear on "Capa/Inscricoes" template
     */
