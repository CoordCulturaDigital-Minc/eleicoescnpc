...
function cnpc_preprocess_comment($comment) {
    if ( strlen( $comment['comment_content'] ) > 8000 ) {
    	wp_die( 'Seu comentário é muito grande. A quantidade máxima permitida é de 8.000 caracteres', 'Comentário grande', array( 'back_link' => true ) );
    }
