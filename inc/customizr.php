...
class Historias_Customize {
   ...
   public static function register ( $wp_customize ) {
      ...
      $wp_customize->add_control( new WP_Customize_Color_Control( //Instantiate the color control class
         ...
         array(
            'label' => __( 'Highlight Color', 'historias' ), //Admin-visible name of the control
   ...
   public static function header_output() {
      ...
      <!--Customizer CSS-->
      <style type="text/css">
           <?php self::generate_css('.menu--main,.feature__status', 'background-color', 'highlight_color'); ?>
      </style>
      <!--/Customizer CSS-->
      <?php
   }
    ...
    * are using 'transport'=>'postMessage' instead of the defawult 'transport'
    * => 'refresh'
    *
   ...
   public static function live_preview() {
      wp_enqueue_script(
           'historias-customizer', // Give the script a unique ID
...
add_action( 'customize_register' , array( 'Historias_Customize' , 'register' ) );

// Output custom CSS to live site
add_action( 'wp_head' , array( 'Historias_Customize' , 'header_output' ) );

// Enqueue live preview javascript in Theme Customizer admin screen
add_action( 'customize_preview_init' , array( 'Historias_Customize' , 'live_preview' ) );
